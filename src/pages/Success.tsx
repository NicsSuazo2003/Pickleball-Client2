        ...
        >
          ...
          <div className="bg-teal-50 rounded-2xl p-4 mb-6">
            ...
            <div className="flex items-center justify-center gap-3">
              ...
              <button
                onClick={() => copy(currentBooking.referenceCode)}
          ...
          <div className="text-left space-y-3 mb-6">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium text-slate-700">{formatDateLong(currentBooking.date)}</span>
            </div>
            <div className="flex justify-between text-sm">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="font-bold text-teal-700">{formatCurrency(currentBooking.totalAmount)}</span>
            </div>
          </div>
